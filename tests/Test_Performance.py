...
gpu_freqs = [384000000, 460800000, 537600000, 614400000, 691200000, 768000000, 844800000, 921600000] #[76800000, 153600000, 230400000, 307200000, 384000000, 460800000, 537600000, 614400000, 691200000, 768000000, 844800000, 921600000] 
...
for freq in gpu_freqs:
    ...
    # Modify the makefile to change the MEASUREMENT_INTERVAL 
    i.modify_variable('/home/iloudaros/LoudVA/makefile', 'MEASUREMENT_INTERVAL', '=', (921600000//freq)*5000+1000)
