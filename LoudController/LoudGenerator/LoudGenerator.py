...
if __name__ == '__main__':
    ...
    simulator.plot_events(simulated_events, last_exit_time, plot=True, live=False, log_filename='/home/louduser/LoudVA/LoudController/LoudGenerator/event_log.csv')